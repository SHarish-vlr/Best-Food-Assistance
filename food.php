...
<section class="user-details">
        <div class="container">
            ...
            <h3 class="mt-4 pt-3 white">Select Hotels</h3>
            <div class="col-6">
                <form class="boxed" action="" method="post">
                <?php foreach($check as $check1) { ?>
                    <div class="opt1"> 
                        <input type="radio" name="hotel" id="hotel1" value="<?php echo $check1['Hotel1'] ?>" required="required">
                        <label for="hotel1">
                    ...
                    <div class="opt2"> 
                        <input class="" type="radio" name="hotel" id="hotel" value="<?php echo $check1['Hotel2'] ?>" required="required">
                ...
                <?php } ?>
                    <input class="sub" type="submit" value="Online order" onclick='this.form.action="online.php";' >
                    <input class="sub" type="submit" value="Dine-in" onclick='this.form.action="dinein.php";'>
                </form>    
            </div> 
        </div>
    <section>           
