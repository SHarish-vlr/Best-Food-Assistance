...
$insertOneResult = $online->insertOne(
    ["online_address" => $online_address, "landmark" => $landmark, "quantity" => $quantity, "session_variable" => $session_variable, "order_mode" => $session_variable_online]
);
...
<html lang="en">
    ...
    <section class="user-details">
            <div class="container">
                ...
                <div class="col-6">
                    <h3 class="mt-4 pt-3 white text-center bold">Thank you for placing an order online</h3>
